...
class ReorderPackagesRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'ids.*' => ['integer', 'distinct', Rule::exists(Package::class, 'id')],
            'moved_id' => ['required_without:ids', 'integer', Rule::exists(Package::class, 'id')],
    ...
    public function movedPackageId(): ?int
    {
