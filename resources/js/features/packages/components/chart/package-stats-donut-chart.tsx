...
import { buildPackageStatsDonutData } from '../../utils/package-stats-chart';

type PackageStatsDonutChartProps = {
    className?: string;
...
export function PackageStatsDonutChart({
    className,
    stats,
}: PackageStatsDonutChartProps) {
    const data = React.useMemo(
        () => buildPackageStatsDonutData(stats),
        [stats],
    );
