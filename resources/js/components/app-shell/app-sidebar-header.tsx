...
export function AppSidebarHeader({
    ...
    return (
        <header className="sticky top-0 z-20 flex h-16 shrink-0 items-center border-b border-sidebar-border/50 bg-sidebar/80 px-4 backdrop-blur-md transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-16 md:bg-background/80 md:px-6">
